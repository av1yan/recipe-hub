      ...
      <div style={{ flex: 1, overflowY: 'auto', padding: '16px' }}>
        ...
        {loading ? (
          ...
          <div style={{ textAlign: 'center', paddingTop: '40px' }}>
            <div style={{ width: '52px', height: '52px', borderRadius: '26px', background: '#f0f7ed', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 14px' }}>
              <BookOpen size={22} color={GREEN} />
            </div>
            <p style={{ fontSize: '15px', fontWeight: '700', color: '#1e293b', margin: '0 0 4px' }}>Nothing in here yet</p>
